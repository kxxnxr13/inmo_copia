...
-- INMOBILIARIA LEAL - phpMyAdmin
-- ====================================

-- 1. Crear la base de datos
CREATE DATABASE IF NOT EXISTS inmobiliaria_leal 
CHARACTER SET utf8mb4 
COLLATE utf8mb4_unicode_ci;

USE inmobiliaria_leal;
...
UNION ALL
SELECT 'PROPIEDADES' as tabla, COUNT(*) as total FROM properties  
UNION ALL
SELECT 'SOLICITUDES' as tabla, COUNT(*) as total FROM contact_requests;
...
SELECT '=== PROPIEDADES ===' as info;
SELECT id, title, price, location, type, status FROM properties;

SELECT '=== SOLICITUDES ===' as info;
SELECT cr.id, cr.name, cr.email, cr.phone, p.title as propiedad, cr.status 
